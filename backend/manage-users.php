          ...
          <ul class="nav flex-column">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                <div
                    ...
                    <h2>Manage Participant</h2> <a href="add-user.php" class="btn btn-success">Add Participant</a>
                </div>
                        ...
                        <?php if (mysqli_num_rows($users) > 0) : ?>
                                <?php while ($user = mysqli_fetch_assoc($users)) : ?>
                                  <tr>
                                    ...
                                    ?></td>        
                                    <td><?= $user['username'] ?></td>        
                                    <td><a href="<?= ROOT_URL ?>backend/display.php?id=<?= $user['id'] ?>"  class="btn btn-submit">View Profile</a></td>
                                    <td><button class="btn btn-primary edit-user-btn" id="<?= $user['id'] ?>" data-bs-toggle="modal" data-bs-target="#modalSigninEdit">Edit</button></td>
                                    <td><a onclick="validate(this)" href="<?= ROOT_URL ?>php/delete-user.php?id=<?= $user['id'] ?>"  class="btn btn-danger">Delete</a></td>
                            </tr>
                        <?php endwhile ?>
                    <?php else :  ?>
                        <tr>
                            <td colspan="5" class="text-center p-2"> No Category Created</td>
                        </tr>
                    <?php endif  ?>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form class="edit-user-modal" enctype="multipart/form-data">
                <div class="form-floating mb-3">
                    <div class="error-txtmodal"></div>
                </div>
                <div class="row">
                            <input type="hidden" class="form-control" name="prev_id" id="prev_user_id" placeholder="User PREV Id">
                            <input type="hidden" class="form-control" name="prev_password" id="prev_user_password" placeholder="User PREV Password">
                    ...
                    <div class="col-md-6">
                        <select class="form-control p-3 mb-3 rounded" name="country" id="country">
                    ...
                    <div class="col-md-6">
                        <select class="form-control p-3 mb-3 rounded" name="riwayat" id="riwayat">
                            <option selected disabled>Select Riwayat</option>
                            ...
                            <option value="Albizi and Qunbol An Ibn Katheer">Albizi and Qunbol A'n Ibn Katheer</option>
                            <option value="Khelaad An Hemzah">Khelaad A'n Hemzah</option>
                            <option value="Qunbel An Ibn Katheer">Qunbel A'n Ibn Katheer</option>
                            <option value="Albizy An Ebn Katheer">Albizy A'n Ebn Katheer</option>
                            <option value="Rawis An Yakoob Al Hadrami">Rawis A'n Yakoob Al Hadrami</option>
                            <option value="Ishaaq Al-Weraaq An Khalef Al-Bezar">Ishaaq Al-Weraaq A'n Khalef Al-Bezar
                            </option>
                            <option value="Hicham An ibn Aamr">Hicham A'n ibn Aamr</option>
                            <option value="Ibn Jemaaz An Aby Jafar">Ibn Jemaaz A'n Aby Ja'far</option>
                            <option value="Ibn Werdan An Aby Jafar">Ibn Werdan A'n Aby Ja'far</option>
                            <option value="Rawh An Yakoob El Hadrami">Rawh A'n Yakoob El Hadrami</option>
                            <option value="Idriss Al-Hadaad An Khelaf Al-Bezaar">Idriss Al-Hadaad A'n Khelaf Al-Bezaar
                            </option>
                            <option value="Warsh An Nafi Min Tryq Aby Bkr Al-Asbhany">Warsh A'n Nafi' Min Tryq Aby Bkr
                                Al-Asbhany</option>
                            <option value="Rowis and Rawh An Yakoob Al Hadrami">Rowis and Rawh A'n Yakoob Al Hadrami
                            </option>
                            <option value="Qalon An Nafi Men Tariq Abi Nasheet">Qalon A'n Nafi' Men Tariq Abi Nasheet
                            </option>
                            <option value="Shbt Wa Hafs An Assem">Sh'bt Wa Hafs A'n Assem</option>
                        </select>
                    </div>
                    <div class="col-md-6">
                        <div class="form-floating mb-3">
                ...
                <button class="w-100 btn btn-lg btn-primary update-user-btn" type="submit">Update Participant </button>
          </form>
      </div>
    </div>
  </div>
