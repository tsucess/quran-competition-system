<?php
  ...
  if (isset($_GET['id'])) {
    $userId = $_GET['id'];
    $query = "SELECT * FROM participant WHERE id = $userId";
...
<head>
    ...
    <title>Participant Profile mode</title>
    ...
    <main>
        <div class="container ">
            ...
            <div class="row mt-5 mb-3">
                <div class="col-md-12">
                    <h4 class="display-6 fw-bold text-center">Participant's Profile</h4>
                </div>
            </div>
            <div class="row my-3">
                <div class="col-lg-4">
            ...
            <div class="row row-cols-1 row-cols-md-1 row-cols-lg-2">
                ...
                <div class="col-lg-8">
                    <table class="table display-profile">
                        <tbody>
                            <tr>
                                <th>Name:</th>
