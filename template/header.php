...
<head>
  ...
  <!-- Font Awesome -->
    ...
    <!-- Custom CSS  -->
    <link rel="stylesheet" href="<?= ROOT_URL ?>/css/custom.css">
                  ...
                  <div class="collapse navbar-collapse" id="navbarCollapse">
                    ...
                    <div class="col-md-4 text-end">
                      <?php if(isset($_SESSION['user_id'])): ?>
                        <a href="<?= ROOT_URL?>php/logout.php" class="btn btn-outline-primary me-2">Sign Out</a>
                        <?php else : ?>
                          <a href="<?= ROOT_URL?>signin.php" class="btn btn-outline-primary me-2">Login</a>
                          <a href="<?= ROOT_URL?>user-signup.php" class="btn btn-primary">Sign-up</a>
                        <?php endif ?>
                    </div>
                  </div>
                </div>
